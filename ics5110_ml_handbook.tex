...
\begin{document}
	...
	\node[inner sep=0pt] (background) at (current page.center) {\includegraphics[width=\paperwidth]{cover/cover_oreilly_style.pdf}};
...
\par\smallcaps{Jean-Paul Ebejer, Dylan Seychell, Lara Marie Demajo, Daniel Farrugia, \hl{ADD YOUR NAME TO THIS LIST} } %TODO
...
%% \input{terms/myterm_jpe.tex}
\input{terms/crossvalidation_lmd.tex} %TODO
...
\bibliography{terms/crossvalidation_lmd,terms/confusionmatrix_df}
