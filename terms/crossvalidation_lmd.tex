...
\begin{itemize}
\item Leave-$p$-out (L$p$O) \newline \index{cross-validation!leave-p-out}
...
\item Leave-one-out (LOO)\newline \index{cross-validation!leave-one-out}
...
\begin{itemize}
\item Holdout method \newline \index{cross-validation!holdout}
...
\item $k$-fold\newline \index{cross-validation!k-fold}
