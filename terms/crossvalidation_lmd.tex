...
\begin{subfigure}
  \centering
  \includegraphics[width=.4\linewidth]{cross_validation/leavep.png}
  \caption{Leave-p-Out}
  \end{subfigure}
 \begin{subfigure}
  \centering
  \includegraphics[width=.37\linewidth]{cross_validation/leave1.png}
...
\begin{subfigure}
  \centering
  \includegraphics[width=0.4\linewidth]{cross_validation/underfitting.png}
  \caption{Underfitting}
  \label{fig:underfitting}
\end{subfigure}
\begin{subfigure}
  \centering
  \includegraphics[width=.4\linewidth]{cross_validation/overfitting.png}
  \caption{Overfitting}
