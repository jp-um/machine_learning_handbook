...
\begin{subfigure}
  \centering
  \includegraphics[width=.4\linewidth]{graphics/cross_validation/leavep.png}
  \caption{Leave-p-Out}
  \end{subfigure}
 \begin{subfigure}
  \centering
  \includegraphics[width=.37\linewidth]{graphics/cross_validation/leave1.png}
...
\begin{figure}
\centering
  \includegraphics[width=0.5\linewidth]{graphics/cross_validation/kfold.png}
...
\begin{subfigure}
  \centering
  \includegraphics[width=0.4\linewidth]{graphics/cross_validation/underfitting.png}
  \caption{Underfitting}
  \label{fig:underfitting}
\end{subfigure}
\begin{subfigure}
  \centering
  \includegraphics[width=.4\linewidth]{graphics/cross_validation/overfitting.png}
  \caption{Overfitting}
...
\begin{figure*}
\centering
  \includegraphics[width=0.88\linewidth]{graphics/cross_validation/example-cv.png}
